...
public class Matrix {
    ...
    /**
     * Create a matrix of shape (rows, columns) and initializes the elements to the
     * specified value.
    ...
    /**
     * Format matrix content row-wise and to prevent java from creating its own
     * version of toString.
     * 
     ...
     * The largest aligns with y-axis, the second largest aligns with x-axis and
     * last with the z-axis.
     * 
    ...
    public Matrix alignPointCloudAlongVerticalAxis(boolean flipUpsideDown) {
        ...
        // - first column corresponds to the 2nd largest eigenvector to align with the
        // x-axis
        // - second column corresponds to the largest eigenvector to align with the
        // y-axis
        // - third column corresponds to the smallest eigenvector to align with the
        // z-axis
